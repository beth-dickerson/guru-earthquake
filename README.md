...
Hello! Earthquake Data will show you some interesting info about top earthquake activity around the world. Search the data. Be amazed.

1. Clone the git repo here:
